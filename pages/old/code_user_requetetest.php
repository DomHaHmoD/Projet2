...
if (empty($_POST['requete_input'])) {
    ...
    echo 'je passe par empty et $total :'.$total;
    echo '<br/>';
    echo '----';
    echo 'je passe par empty et $requete :';
    print_r($requete);
    echo '<br/>';
    echo '----';
} else {
...
echo '<br/>';
echo '-----------';
print_r($donnees_total->fetchAll(PDO::FETCH_ASSOC));
echo '<br/>';
